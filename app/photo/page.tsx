  ...
  return (
    <div className="min-h-full">
      <div className="sticky top-0 z-10 bg-white/90 backdrop-blur-sm border-b border-stone-100 px-4 py-3">
        <h1 className="text-lg font-bold text-stone-700">拍照辨識 📷</h1>
        <p className="text-xs text-stone-400">用 Google Lens 辨識日文商品</p>
      </div>
      ...
      <div className="px-4 py-8 flex flex-col items-center gap-6">
        <a
          ...
          className="w-full rounded-2xl py-5 flex flex-col items-center gap-2 shadow-sm active:opacity-80 text-white"
        ...
        <div className="w-full bg-white rounded-2xl border border-stone-100 shadow-sm p-4 space-y-3">
          <h2 className="font-semibold text-stone-700 text-sm">使用步驟</h2>
          {[
            ['📷', '點上方按鈕開啟 Google Lens'],
            ['🎯', '對準商品拍照或從相簿選圖'],
            ['🔍', 'Google 自動辨識並顯示說明'],
